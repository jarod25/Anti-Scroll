...
data class SharedSessionDeadline(
...
class SharedSessionDeadlinePlanner {
    fun plan(
        ...
        val foregroundDuration = activeState.foregroundDurationAt(
        ...
        return SharedSessionDeadline(
            ...
            elapsedRealtime = activeState.lastObservedElapsedRealtime.plus(
                nonNegativeRemainingDuration
            )
        )
    }
}
